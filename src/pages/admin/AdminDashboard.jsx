      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-[var(--color-card)] p-6 rounded-xl border border-[var(--color-border)]">
          ...
          <div className="space-y-3">
            <Link to="/admin/reports" className="block p-3 bg-[var(--color-background)] border border-[var(--color-border)] rounded-lg hover:border-[var(--color-primary)] transition-all">
              {t('admin.reports')}
            </Link>
            <div className="block p-3 bg-[var(--color-background)] border border-[var(--color-border)] rounded-lg hover:border-[var(--color-primary)] transition-all cursor-pointer">
              {t('admin.manage_users')}
            </div>
            <div className="block p-3 bg-[var(--color-background)] border border-[var(--color-border)] rounded-lg hover:border-[var(--color-primary)] transition-all cursor-pointer">
              {t('admin.approve_terrains')}
            </div>
          </div>
        </div>
      </div>
